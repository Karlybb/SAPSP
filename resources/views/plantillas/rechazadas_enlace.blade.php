            ...
            <tr id="tablarojo">
                ...
                <td>
                    <!--<b>Motivo:</b><br>
                                ...
                                <b>Recibida:</b><br>
                                <span class="glyphicon glyphicon-pencil"></span> {{$ob->fecha_enviousuario}}<br><br>-->

                    <b><span class="glyphicon glyphicon-info-sign"></span> Estatus: </b>
                    {{$ob->descestado}}<br>

                    <b><span class="glyphicon glyphicon-user"></span> Env&iacute;a:</b>
                    {{$ob->nombre1}} {{$ob->nombre2}} {{$ob->apellidopat}} {{$ob->apellidomat}}<br>
                    <!--<span class="glyphicon glyphicon-envelope"></span> <b>{{$ob->correo}}</b>-->

                    <!--<b>Rechazada:</b><br>
                                <span class="glyphicon glyphicon-remove"></span> {{$ob->fecha_validacionenlace}}<br><br>-->
                ...
                <td style="padding-top: 1%">
                    <form action="cedulainfo" method="post">
                        ...
                        <input type="hidden" name="regreso" value="2001" />
