...
<div class="container log">
    ...
    <form action="{{route('logeo')}}" method="post" autocomplete="off">
      @csrf
      ...
      <div class="col-md-2 center">
          ...
          <div class="inputs">
            ...
            <div class="form-group campo">
              ...
              <input type="email" name="email" maxlength="30" value="{{old('email')}}"
            ...
            <div class="form-group campo">
              ...
              <input type="password" name ="pass" maxlength="10" value="{{old('pass')}}" class="form-control" id="pwd" title="Ingresa tu contraseña con el que fuiste dado de alta en el sistema SAPSP." placeholder="Contraseña" required>
              @error('pass')
                <small><b>* {{$message}}</b></small>
              @enderror
            </div>
